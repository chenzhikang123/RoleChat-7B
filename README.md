...
> 评测样本：48 条 | 评判模型：Qwen/Qwen3-235B-A22B-Instruct-2507 | 评分维度：1–5 分

### 各维度均分对比

| 模型 | 角色一致性 | 情绪共情度 | 回复质量 | 平均分 |
|------|:---------:|:---------:|:-------:|:-----:|
| Qwen2.5-7B（基座） | 3.83 | 3.90 | 3.94 | 3.89 |
| RoleChat-7B SFT+DPO | 4.75 | 4.60 | 4.02 | 4.46 |
| **RoleChat-7B SFT+DPO+RAG** | **4.92** | **4.79** | **4.73** | **4.81** |

三阶段递进微调后，最终模型在角色一致性、情绪共情度、回复质量三个维度上均全面超越基座，综合平均分从 3.89 提升至 **4.81**（+23.6%）。

### 各角色分项均分

| 角色 | 基座均分 | SFT+DPO均分 | +RAG均分 |
|------|:-------:|:-----------:|:-------:|
| 人生顾问 | 4.27 | 4.00 | 4.80 |
| 可靠兄长 | 3.61 | 4.72 | 4.22 |
| 幽默朋友 | 3.47 | 4.13 | **5.00** |
| 心理咨询师 | 3.83 | 4.50 | **5.00** |
| 温暖姐姐 | 3.61 | 4.61 | 4.83 |
| 生活导师 | 4.50 | 4.39 | 4.67 |
| 睿智长者 | 4.10 | 4.38 | **5.00** |
| 知心朋友 | 3.71 | 4.76 | 4.95 |

幽默朋友、心理咨询师、睿智长者三个角色在 RAG 加持下达到满分，说明知识库动态检索对角色行为精准度的增益显著。
